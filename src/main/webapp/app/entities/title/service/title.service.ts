...
export class TitleService {
  ...
  update(title: ITitle): Observable<EntityResponseType> {
    return this.http.put<ITitle>(`${this.resourceUrl}/${this.getTitleIdentifier(title)}`, title, { observe: 'response' });
  }

  partialUpdate(title: PartialUpdateTitle): Observable<EntityResponseType> {
    return this.http.patch<ITitle>(`${this.resourceUrl}/${this.getTitleIdentifier(title)}`, title, { observe: 'response' });
  }
