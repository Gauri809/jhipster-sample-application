...
/**
 * REST controller for managing {@link com.eccomerce.mygd.domain.Catagory}.
 */
@RestController
@RequestMapping("/api")
public class CatagoryResource {
    ...
    public CatagoryResource(CatagoryService catagoryService, CatagoryRepository catagoryRepository) {
    ...
    public ResponseEntity<Catagory> updateCatagory(
        ...
        Catagory result = catagoryService.update(catagory);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, catagory.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/catagories/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<Catagory> partialUpdateCatagory(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, catagory.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<Catagory>> getAllCatagories(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Catagories");
        Page<Catagory> page = catagoryService.findAll(pageable);
