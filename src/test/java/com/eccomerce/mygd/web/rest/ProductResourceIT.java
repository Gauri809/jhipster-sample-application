...
import com.eccomerce.mygd.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getUserGender()).isEqualTo(DEFAULT_USER_GENDER);
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        assertThat(testProduct.getUserGender()).isEqualTo(UPDATED_USER_GENDER);
    }
